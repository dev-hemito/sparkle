...
<div class="page-wrapper">
                ...
                <div class="inner-container">
                    ...
                    <div class="right-column">
                        ...
                        <ul class="contact-info">
                            <li><a href="tel:+918950335033"><i class="flaticon-call"></i>+918950335033</a></li>
                            <li><a href="mailto:info@sparkleclean.in"><i class="flaticon-email-1"></i>info@sparkleclean.in </a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <!-- Page Title -->
    <section class="page-title" style="background-image: url(assets/images/background/common.png);">
        <div class="auto-container">
            <h1>Pricing Table</h1>
            ...
            <div class="row">
                <div class="col-lg-4 pricing-block">
                    <div class="inner-box wow fadeInUp" data-wow-duration="1500ms">
                        <div class="price">$30<sub>/mo</sub></div>
                        <h4>Standard Pest <br> Control</h4>
                        <div class="content">
                            <ul>
                                <li>Household pests Control</li>
                                <li>Rodent Control</li>
                                <li>Re-Service at No-Charge</li>
                                <li class="unavailable">Termite Control</li>
                ...
                <div class="col-lg-4 pricing-block">
                    <div class="inner-box wow fadeInDown" data-wow-duration="1500ms">
                        <div class="price">$40<sub>/mo</sub></div>
                        <h4>Advanced Pest <br>Control</h4>
                        <div class="content">
                            <ul>
                                <li>Household pests Control</li>
                                <li>Rodent Control</li>
                ...
                <div class="col-lg-4 pricing-block">
                    <div class="inner-box wow fadeInUp" data-wow-duration="1500ms">
                        <div class="price">$50<sub>/mo</sub></div>
                        <h4>Complete Pest <br>  Control</h4>
                        <div class="content">
                            <ul>
                                <li>Household pests Control</li>
                                <li>Rodent Control</li>
    ...
    <section class="cta-section">
        ...
        <span class="shape-three"><img src="assets/images/shape/shape-2.png" alt=""></span>
        <div class="auto-container">
            <div class="row">
                <div class="col-lg-6">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-7">
                        <div class="widget about-widget">
                            <h4 class="widget_title">About Sparkleclean.</h4>
                            <div class="text">Nostrud exertation ullamco labor nisi aliquip <br> ex ea commodo consequat duis aute irure <br> dolor in reprehenderit in voluptate velit esse <br> cillum dolore.</div>
                            <div class="copyright"><a href="#">Sparkleclean</a> © 2020 All Right Reserved</div>
                        </div>
                    </div>
                        ...
                        <div class="widget links-widget">
                            ...
                            <div class="widget-content">
                                <ul class="list">
                                    ...
                                    <li><a href="#">Office Sa nitizing </a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 offset-lg-1 col-md-6">
                        <div class="widget contact-widget">
                            ...
                            <ul>
                                <li>Room No: 118, 1st Floor, DD Vyapar Bhavan, KP Vallon Road, Kadavanthra Ernakulam, Kochi-682020</li>
                                <li><a href="mailto:info@sparkleclean.in">info@sparkleclean.in</a></li>
                                <li><a href="tel:+918950335033">+918950335033</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
...
<!--Scroll to top-->
<div class="CTABtndiv">
    <a  href="https://wa.me/+918950335033" class="CTABtn">
        <div class="CTABtnsign">
        ...
        <div class="CTABtntext">Whatsapp</div>
    </a>
</div>
