        ...
        <section class="services-section" style="margin-bottom: 0px; padding-bottom: 0px;">
            <div class="auto-container">
                ...
                <div class="wrapper-box">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 service-block-one">
                            <div class="inner-box wow fadeInUp" data-wow-duration="1500ms">
                                <div class="icon"><img src='serviceimages/sofa.png' /></div>
                        ...
                        <div class="col-lg-4 col-md-6 service-block-one">
                            <div class="inner-box wow fadeInDown" data-wow-duration="1500ms">
                                <div class="icon"><img src='serviceimages/residential.png' /></div>
                    ...
                    <div class="all-service-link text-center mt-30 mb-30"><a href="<?php echo $BASE_URL; ?>/contact"
                            class="theme-btn btn-style-one style-three"><span>Avail Service Now</span></a></div>
                </div>
            </div>
        </section>
